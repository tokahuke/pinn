...
model.py (premium net, value, deployment adapter), loss.py (the subsolution
objective, ridge condition BC1). simplex.py is two_arm's, reused unchanged --
the drift term never touches the maximization.
